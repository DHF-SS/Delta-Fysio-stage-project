...
<title>
<?php echo $text['meta_contact_title']; ?>
</title>

<meta name="description"
content="<?php echo $text['meta_contact_description']; ?>">
...
content="<?php echo $text['meta_contact_title']; ?>">
...
<div class="logo">
<img src="logo.png" alt="Delta Sportfysiotherapie logo" loading="lazy">
</div>
...
<li>
<a href="contact.php?lang=<?php echo $lang; ?>" class="active">
...
<h1>
<?php echo $text['contact_title']; ?>
</h1>

<p>
<?php echo $text['contact_subtitle']; ?>
</p>
...
<p>
Delta Sportfysiotherapie helpt dagelijks sporters en patiënten met professionele fysiotherapie, revalidatie en hersteltraining.
Onze praktijk in Stellendam biedt persoonlijke begeleiding voor sneller herstel en betere prestaties.
</p>

<p>
Heeft u last van blessures, spierklachten of sportgerelateerde pijn?
Neem vandaag nog contact met ons op voor een afspraak of persoonlijk advies.
</p>
